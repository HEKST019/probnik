    ...
    <div class="site-wrapper">
        ...
        <div class="page-header">
            <div class="site-wrapper">
                ...
                <h1 class="page-title">Пирожок с картошкой</h1>
            </div>
        </div>
                  ...
                  <div class="product-detail">
                      <div class="product-images">
                          <div class="main-product-image">
                              <img src="/img/пирожок-с-картошкой-600x600.jpg" alt="Пирожок с картошкой" class="product-img">
                              <span class="product-badge">Распродажа!</span>
                          </div>
                      </div>

                      <div class="product-info">
                          <h2 class="product-title">Пирожок с картошкой</h2>
                          ...
                          <div class="product-meta">
                              <div class="product-sku">
                                  <strong>Артикул:</strong> <span>а101</span>
                              </div>
