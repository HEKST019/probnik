    ...
    try {
        ...
        $stmt = $pdo->prepare(
            "SELECT p.ID, p.post_title, pm.min_price as price
             FROM wp_posts p
             INNER JOIN wp_wc_product_meta_lookup pm ON p.ID = pm.product_id
...
<link rel="alternate" type="application/rss+xml" title="Столовая &raquo; Лента записей типа &laquo;Товары&raquo;" href="/shop/feed/">
<script>
...
<body class="archive post-type-archive post-type-archive-product wp-theme-phlox theme-phlox woocommerce-shop woocommerce woocommerce-page woocommerce-no-js elementor-default elementor-kit-31 phlox aux-dom-unready aux-full-width aux-resp aux-s-fhd aux-top-sticky  aux-page-animation-off _auxels" data-framed="">
...
<nav id="master-menu-elementor-d052931" class="menu-header-menu-container">
	...
	<ul id="menu-header-menu" class="aux-master-menu aux-no-js aux-skin-classic aux-with-indicator aux-horizontal" data-type="horizontal" data-switch-type="toggle" data-switch-parent=".elementor-element-d052931 .aux-fs-popup .aux-fs-menu" data-switch-width="768">
		<!-- start single menu -->
		<li id="menu-item-289" class="menu-item menu-item-type-post_type menu-item-object-page current-menu-item current_page_item menu-item-289 aux-menu-depth-0 aux-menu-root-1 aux-menu-item">
        ...
        <header id="site-title" class="page-title-section">
            ...
            <div class="page-header aux-wrapper aux-boxed-container aux-top aux-dark" style="display:block;">
                ...
                <div class="aux-container">
                    ...
                    <p class="aux-breadcrumbs"><span class="aux-breadcrumb-sep breadcrumb-icon auxicon-chevron-right-1"></span><span><a title="Главная">Главная</a></span><span class="aux-breadcrumb-sep breadcrumb-icon auxicon-chevron-right-1"></span><span>Товары</span></p>
...
<form class="woocommerce-ordering" method="get">
	...
	<input type="hidden" name="simply_static_page" value="5817">
</form>
...
<li class="product type-product post-65 status-publish first instock product_cat-19 product_cat-18 product_tag-31 product_tag-30 has-post-thumbnail sale taxable shipping-taxable purchasable product-type-simple aux-remove-view-cart">
  ...
  <div class="wp-block-button wc-block-grid__product-add-to-cart">
    <a href="/shop/?add-to-cart=65" aria-label="Добавить в корзину &ldquo;Пирожок с мясом&rdquo;" data-quantity="1" data-product_id="65" data-product_sku="а102" data-price="150" rel="nofollow" class="wp-block-button__link  add_to_cart_button ajax_add_to_cart">В корзину</a>
  </div>



</li>
<li class="product type-product post-61 status-publish instock product_cat-19 product_cat-18 has-post-thumbnail sale taxable shipping-taxable purchasable product-type-simple aux-remove-view-cart">
  ...
  <div class="wp-block-button wc-block-grid__product-add-to-cart">
    <a href="/shop/?add-to-cart=61" aria-label="Добавить в корзину &ldquo;Пирожок с картошкой&rdquo;" data-quantity="1" data-product_id="61" data-product_sku="а101" data-price="150" rel="nofollow" class="wp-block-button__link  add_to_cart_button ajax_add_to_cart">В корзину</a>
  </div>
</li>
</ul>
                    </div>
...
<div class="hide_cart_widget_if_empty"><div class="widget_shopping_cart_content"></div></div></section></div>
<div class="aux-widget-area"></div>                    </div>
<!-- end sidebar-content -->
                </div>
<!-- end sidebar-inner -->
