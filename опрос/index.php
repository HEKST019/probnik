...
<link rel="stylesheet" id="elementor-post-610-css" href="/wp-content/uploads/elementor/css/post-610.css?ver=1756581791" media="all">
...
<script id="wc-add-to-cart-js-extra">var wc_add_to_cart_params = {"ajax_url":"\/wordpress\/wp-admin\/admin-ajax.php","wc_ajax_url":"\/wordpress\/?wc-ajax=%%endpoint%%","i18n_view_cart":"Просмотр корзины","cart_url":"\/cart\/","is_cart":"","cart_redirect_after_add":"no"};</script>
...
<script id="woocommerce-js-extra">var woocommerce_params = {"ajax_url":"\/wordpress\/wp-admin\/admin-ajax.php","wc_ajax_url":"\/wordpress\/?wc-ajax=%%endpoint%%","i18n_password_show":"Показать пароль","i18n_password_hide":"Скрыть пароль"};</script>
...
<script id="auxin-modernizr-js-extra">var auxin = {"ajax_url":"\/wp-admin\/admin-ajax.php","is_rtl":"","is_reponsive":"1","is_framed":"","frame_width":"20","wpml_lang":"en","uploadbaseurl":"\/wp-content\/uploads","nonce":"ce31374cb7"};</script>
...
<link rel="alternate" title="JSON" type="application/json" href="/wp-json/wp/v2/pages/610">
<link rel="EditURI" type="application/rsd+xml" title="RSD" href="/xmlrpc.php?rsd">
<meta name="generator" content="WordPress 6.8.2">
<meta name="generator" content="WooCommerce 10.1.2">
<link rel="canonical" href="/%d0%be%d0%bf%d1%80%d0%be%d1%81/">
<link rel="shortlink" href="/?p=610">
<link rel="alternate" title="oEmbed (JSON)" type="application/json+oembed" href="/wp-json/oembed/1.0/embed?url=%2F%25d0%25be%25d0%25bf%25d1%2580%25d0%25be%25d1%2581%2F">
<link rel="alternate" title="oEmbed (XML)" type="text/xml+oembed" href="/wp-json/oembed/1.0/embed?url=%2F%25d0%25be%25d0%25bf%25d1%2580%25d0%25be%25d1%2581%2F#038;format=xml">
    <meta name="title" content="Опрос">
    <meta name="description" content="Мы обновляем ассортимент и хотим узнать ваше мнение!  Голосуйте за блюдо, которое появится в меню: Ваш выбор поможет сделать столовую лучше!  Спасибо! 😊 #Голосуй_и_вкусно_поешь Какое блюдо вы хотите видеть в нашем меню? Помогите нам выбрать следующую новинку для нашего меню! Крем-суп из тыквы с имбирем Куриные грудки в медово-горчичном соусе Лазанья со шпинатом и рикоттой [&hellip;]">
...
<body class="wp-singular page-template-default page page-id-610 wp-theme-phlox theme-phlox woocommerce-no-js elementor-default elementor-kit-31 elementor-page elementor-page-610 phlox aux-dom-unready aux-full-width aux-resp aux-s-fhd aux-top-sticky  aux-page-animation-off _auxels" data-framed="">
        ...
        <header id="site-title" class="page-title-section">
            ...
            <div class="page-header aux-wrapper aux-auto-height aux-boxed-container aux-left aux-top aux-dark" style="display:block;">
                ...
                <div class="aux-container">
                    ...
                    <p class="aux-breadcrumbs"><span class="aux-breadcrumb-sep breadcrumb-icon auxicon-chevron-right-1"></span><span><a title="Главная">Главная</a></span><span class="aux-breadcrumb-sep breadcrumb-icon auxicon-chevron-right-1"></span><span>Опрос</span></p>
    ...
    <main id="main" class="aux-main aux-territory  aux-single aux-page aux-boxed-container aux-content-top-margin no-sidebar aux-sidebar-style-border aux-user-entry">
        <div class="aux-wrapper">
            <div class="aux-container aux-fold">
				...
				<div class="aux-parallax-section elementor-element elementor-element-d52d82e e-flex e-con-boxed e-con e-parent" data-id="d52d82e" data-element_type="container">
					<div class="e-con-inner">
				<div class="elementor-element elementor-element-5c9c454 elementor-widget elementor-widget-text-editor" data-id="5c9c454" data-element_type="widget" data-widget_type="text-editor.default">
				<div class="elementor-widget-container">
...
<p><em>#Голосуй_и_вкусно_поешь</em></p>								</div>
				</div>
				<div class="elementor-element elementor-element-9238043 elementor-widget elementor-widget-html" data-id="9238043" data-element_type="widget" data-widget_type="html.default">
				<div class="elementor-widget-container">
					<div id="dish-poll">
    <h2>Какое блюдо вы хотите видеть в нашем меню?</h2>
    <p>Помогите нам выбрать следующую новинку для нашего меню!</p>

    <div class="poll-options">
        <div class="poll-option">
            <input type="radio" id="dish1" name="dish" value="Крем-суп из тыквы с имбирем">
            <label for="dish1">
                <img decoding="async" src="/flask/img/krem-sup-iz-tykvy.jpg" alt="Крем-суп из тыквы с имбирем">
        ...
        <div class="poll-option">
            ...
            <label for="dish2">
                <img decoding="async" src="/flask/img/kyrgryd.jfif" alt="Куриные грудки в медово-горчичном соусе">
        ...
        <div class="poll-option">
            ...
            <label for="dish3">
                <img decoding="async" src="/flask/img/lazan.jpg" alt="Лазанья со шпинатом и рикоттой">
        ...
        <div class="poll-option">
            ...
            <label for="dish4">
                <img decoding="async" src="/flask/img/caption.jpg" alt="Фалафель с хумусом и лепешкой">
    ...
    <div id="poll-results" style="display: none;">
        ...
        <div class="result-chart">
          <span class="dish-name">Крем-суп из тыквы с имбирем</span>
            <div class="result-bar" data-dish="Крем-суп из тыквы с имбирем" style="width: 0%;">
            ...
            <div class="result-bar" data-dish="Куриные грудки в медово-горчичном соусе" style="width: 0%;">

                <span class="dish-percent">0%</span>
                <span class="dish-votes">(0 голосов)</span>
            </div>
            <span class="dish-name">Лазанья со шпинатом и рикоттой</span>
            <div class="result-bar" data-dish="Лазанья со шпинатом и рикоттой" style="width: 0%;">

                <span class="dish-percent">0%</span>
                <span class="dish-votes">(0 голосов)</span>
            </div>
            <span class="dish-name">Фалафель с хумусом и лепешкой</span>
            <div class="result-bar" data-dish="Фалафель с хумусом и лепешкой" style="width: 0%;">

                <span class="dish-percent">0%</span>
                <span class="dish-votes">(0 голосов)</span>
            </div>
        </div>
        <div class="total-votes">Всего голосов: <span id="total-votes">0</span>
</div>
    </div>
...
<style>#dish-poll {
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        voteBtn.addEventListener('click', function() {
            ...
            console.log('Выбранное блюдо:', selectedDish ? selectedDish.value : 'не выбрано');
    ...
    for (const dish in pollResults) {
        ...
        if (bar) {
            ...
            console.log(`Блюдо: ${dish}, Голосов: ${votes}, Процент: ${percent}%`);
        }
    }
}
