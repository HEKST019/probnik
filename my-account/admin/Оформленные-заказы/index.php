                            ...
                            <tbody>
                                ...
                                <?php endwhile; ?>
										...
										<div style="text-align: center; margin: 30px 0;">
												<a href="../../generate_orders.php" class="btn-secondary">📊 Сгенерировать отчет по заказам</a>
												<a href="/my-account/file_manager.php" class="btn-secondary">📁 Файловый менеджер</a>
												<a href="status.php" class="btn-secondary">Статусы по заказам</a>
										</div>
