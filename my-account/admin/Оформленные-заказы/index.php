<?php if($_COOKIE['user'] == 'admin1'): ?>
	...
	<script src="/wp-content/plugins/woocommerce/assets/js/frontend/account-i18n.min.js?ver=10.1.2" id="wc-account-i18n-js" defer data-wp-strategy="defer"></script>
	...
	<link rel="shortlink" href="/?p=28">
	    <meta name="title" content="Оформленные заказы">
	...
	<body class="wp-singular page-template-default page page-id-28 wp-theme-phlox theme-phlox woocommerce-account woocommerce-page woocommerce-no-js elementor-default elementor-kit-31 phlox aux-dom-unready aux-full-width aux-resp aux-s-fhd aux-top-sticky  aux-page-animation-off _auxels" data-framed="">
	...
	<nav id="master-menu-elementor-d052931" class="menu-header-menu-container">
		...
		<ul id="menu-header-menu" class="aux-master-menu aux-no-js aux-skin-classic aux-with-indicator aux-horizontal" data-type="horizontal" data-switch-type="toggle" data-switch-parent=".elementor-element-d052931 .aux-fs-popup .aux-fs-menu" data-switch-width="768">
			...
			<!-- end single menu -->
			<!-- start single menu -->
			<li id="menu-item-295" class="menu-item menu-item-type-post_type menu-item-object-page current-menu-item page_item page-item-28 current_page_item menu-item-295 aux-menu-depth-0 aux-menu-root-7 aux-menu-item">
	        ...
	        <header id="site-title" class="page-title-section">
	            ...
	            <div class="page-header aux-wrapper aux-auto-height aux-boxed-container aux-left aux-top aux-dark" style="display:block;">
	                ...
	                <div class="aux-container">
	                    ...
	                    <p class="aux-breadcrumbs"><span class="aux-breadcrumb-sep breadcrumb-icon auxicon-chevron-right-1"></span><span><a title="Главная">Главная</a></span><span class="aux-breadcrumb-sep breadcrumb-icon auxicon-chevron-right-1"></span><span>Оформленные заказы</span></p>
...
$query = $pdo->query('SELECT * FROM `wp_order_addresses`');
?>
